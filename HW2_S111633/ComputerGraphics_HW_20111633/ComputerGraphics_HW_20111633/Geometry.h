...
// 4.5.5
#define GEOM_OBJ_ID_SQUARE16 6
#define GEOM_OBJ_ID_TIGER 7
#define GEOM_OBJ_ID_COW2 8
...
void prepare_geom_obj(int geom_obj_ID, char *filename, int n_bytes_per_vertex) {
	geom_obj_n_triangles[geom_obj_ID] = read_triangular_mesh(&geom_obj_vertices[geom_obj_ID],
...
void draw_geom_obj(int geom_obj_ID, float r, float g, float b) {
